    ...
    <div class="main-content">
      <main>
        <div class="page-header">
          ...
          <nav class="breadcrumb is-right is-small" aria-label="breadcrumbs">
            <ul>
              ...
              <li class="is-active"><a href="#" aria-current="page">Fornecedores</a></li>
            </ul>
          </nav>
        </div>
              ...
              <div class="field is-horizontal">
                <div class="field-body">
                  <div class="field"> <!--Usuario-->
                    <input class="input is-small" type="text" placeholder="Fornecedor" v-model="bFornecedor">
                  </div>
                  <div class="field"> <!--Usuario-->
                    <input class="input is-small" type="text" placeholder="CPF/CNPJ" v-model="bDocumento">
                  </div>
                  <div class="field"> <!--Usuario-->
        ...
        <div :class="{ modal: true, 'is-active': showModal }">
          ...
          <div class="modal-card">
            <header class="modal-card-head">
              <p class="modal-card-title">Novo Fornecedor</p>
                ...
                <div class="field-body">
                  <div class="field"> <!--Nome do Usuario-->
                    <p class="control is-expanded">
                      <label class="label is-small">Fornecedor:</label>
                      <input class="input is-small" type="text" placeholder="Descrição do Fornecedor"
                        v-model="fornecedor">
                    </p>
                  </div>
                </div>
                ...
                <div class="field-body">
                  ...
                  <div class="field"> <!--Nome do Usuario-->
                    <p class="control is-expanded">
                      ...
                      <input class="input is-small" type="text" placeholder="CPF ou CNPJ" v-model="documento">
                    </p>
                  </div>
                  <div class="field"> <!--Nome do Usuario-->
                    <p class="control is-expanded">
                      <label class="label is-small">E-mail:</label>
                      <input class="input is-small" type="email" placeholder="contato@email.com" v-model="email">
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div class="field-body">
                  <div class="field"> <!--Usuario-->
                    <p class="control is-expanded">
                      ...
                      <input class="input is-small" type="text" placeholder="(##) ####-####" v-model="telefone">
                    </p>
                  </div>
                  <div class="field"> <!--Usuario-->
                    <p class="control is-expanded">
                      <label class="label is-small">Celular:</label>
                      <input class="input is-small" type="text" placeholder="(##) ####-####" v-model="celular">
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div :class="{ modal: true, 'is-active': showModalUpdate }">
          ...
          <div class="modal-card">
            <header class="modal-card-head">
              <p class="modal-card-title">Editar Fornecedor</p>
              <button class="delete" aria-label="close" @click="HideModal"></button>
            </header>
            <section class="modal-card-body">
              <!-- Content ... -->
              ...
              <div class="field is-horizontal">
                <div class="field-body">
                  <div class="field"> <!--Nome do Usuario-->
                    <p class="control is-expanded">
                      <label class="label is-small">Fornecedor:</label>
                      <input class="input is-small" type="text" v-model="fornecedor">
                    </p>
                  </div>
                  <div class="field"> <!--Nome do Usuario-->
                    <p class="control is-expanded">
              ...
              <div class="field is-horizontal">
                <div class="field-body">
                  ...
                  <div class="field"> <!--Usuario-->
                    <p class="control is-expanded">
                      <label class="label is-small">Celular:</label>
                      <input class="input is-small" type="text" v-model="celular">
                    </p>
                  </div>
                  <div class="field"> <!--Usuario-->
...
export default {
  ...
  created() {
    ...
    axios
      .get("https://barberapi-db08894f5bfd.herokuapp.com/api/supplier", req)
      .then((res) => {
        this.bd = res.data;
  ...
  data() {
    return {
      ...
      paginaAtual: 1,
      /*EXPORTAÇÃO*/
      newFileName: "Cadastro de Fornecedores"
    }
  },
  props: {
  ...
  methods: {
    ...
    ShowModalUpdate(id) {
      ...
      axios
        .get("https://barberapi-db08894f5bfd.herokuapp.com/api/supplier/" + this.deleteItemId, req)
        .then(res => {
          console.log(res);
    ...
    register() {
      ...
      axios
        .post("https://barberapi-db08894f5bfd.herokuapp.com/api/supplier", {
    ...
    deleteItem() {
      ...
      axios
        .delete("https://barberapi-db08894f5bfd.herokuapp.com/api/supplier/" + this.deleteItemId, req)
        .then(res => {
          console.log(res);
          this.showModalDelete = false;
          // pesquisa
    ...
    updateItem() {
      ...
      axios
        .put("https://barberapi-db08894f5bfd.herokuapp.com/api/supplier/" + this.deleteItemId, {
    ...
    buscarService: function () {
      ...
      if (
        this.bFornecedor != '' || this.bFornecedor != ' ' &&
        this.bDocumento != '' || this.bDocumento != ' ' &&
        this.bEmail != '' || this.bEmail != ' ' &&
        this.bStatus != '' || this.bStatus != ' '
      ) {
        this.dadosPaginados = this.bd.filter(bd => bd.fornecedor.match(this.bFornecedor) && bd.documento.match(this.bDocumento) && bd.email.match(this.bEmail) && bd.status.match(this.bStatus));
